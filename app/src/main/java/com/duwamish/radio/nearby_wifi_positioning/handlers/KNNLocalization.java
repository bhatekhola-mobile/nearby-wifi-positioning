...
public class KNNLocalization {
    ...
    private class LocalizationAlgorithmTask extends
        ...
        protected void onPostExecute(Integer results) {
            ...
            NearbyViewController.mainactivity.uiUpdate();
    ...
    public int localizationAlogrithm(float rss[], float radioMap[][], int K,
        ...
        int N = rss.length;
        Log.i("KNNLocalization", "M = " + String.valueOf(M) + "N= " + N);
        ...
        Log.i("KNNLocalizationL_search", "L_search = " + L_search);
        ...
        NearbyViewController.mainactivity.result_x0 = result_x0;
        NearbyViewController.mainactivity.result_y0 = result_y0;
        NearbyViewController.mainactivity.result_num0 = result_num0;
        Log.i("KNNLocalization", "X = " + String.valueOf(x) + "N= " + String.valueOf(y));
        return p_temp.num;
    }
